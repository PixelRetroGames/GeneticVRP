#include "linear_fitness_calculator.h"
...
void VRP::LinearFitnessCalculator::calculate(genetic::IndividualArray &individuals, double *fitness) {
...
void VRP::LinearFitnessCalculator::sort(genetic::IndividualArray &individuals, double *fitness) {
...
void VRP::LinearFitnessCalculator::printIndividual(VRP::VRPIndividual *individual, int genomeSize) {
...
double VRP::LinearFitnessCalculator::calculate(double *genome, int genomeSize, bool print) {
...
double VRP::LinearFitnessCalculator::getDistance(pair<int, int> a, pair<int, int> b) {
    //printf("A = %d; %d\n", a.first, a.second);
    //printf("B = %d; %d\n", b.first, b.second);
